...
define("SFB_BASE",			"../../uploads/");		// upload folder (relative to sfbpath)

define("SFB_LANG",			defined('WP_SFB_LANG')?WP_SFB_LANG:"en");		// the language ISO code
...
define("SFB_DEBUG",			defined('WP_SFB_DEBUG')?WP_SFB_DEBUG:false);
?>